...
public class ContestRepository implements IContestRepository { 
    ...
    public List<Contest> findAll() {
       List<Contest> contestList =  contestMap.values().stream().collect(Collectors.toList());
     return contestList;
    }
    ...
    public List<Contest> findAllContestLevelWise(Level level) {
        List<Contest> contestList = contestMap.values().stream().collect(Collectors.toList());
        List<Contest> resultList = contestList.stream().filter(contest -> contest.getLevel() == level).collect(Collectors.toList());
     return resultList;
    }
